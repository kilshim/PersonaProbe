...
export const IdeaInput: React.FC<IdeaInputProps> = ({ idea, setIdea, onGenerate, isLoading }) => {
  return (
    <div className="w-full max-w-2xl mx-auto animate-fade-in-up">
      <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 dark:border-gray-700 p-8 transition-colors duration-300">
        <div className="flex items-center justify-center mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white">어떤 서비스를 만들고 계신가요?</h2>
        </div>
        ...
        <textarea
          ...
          className="w-full h-40 p-4 border border-gray-200 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-gray-50 dark:bg-gray-900 resize-none text-gray-700 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 transition-all"
        />
